package com.zyys.yunxin.adapter;
...
//                            flag = false;
//                        }
                        View llt_msg = inflater.inflate(Rmedicine_order_item.xml.layout.ll_add_view_item, null);
